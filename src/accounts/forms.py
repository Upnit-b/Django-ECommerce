...
class RegistrationForm(forms.ModelForm):
    ...
    # function for checking password and confirm password match
    ...
    # we can add classes individually to each field by adding the "class" in attrs dictionary as we mentioned the placeholder in the attrs above, but below is a shorter way to add class to all the fields
